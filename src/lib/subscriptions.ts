...
export const SERVICE_PRESETS: ServicePreset[] = [
  ...
  { name: 'Hulu', category: 'TV & film', cycle: 'monthly' },
  { name: 'Max', category: 'TV & film', cycle: 'monthly' },
  { name: 'Disney+', category: 'TV & film', cycle: 'monthly' },
  { name: 'Peacock', category: 'TV & film', cycle: 'monthly' },
  { name: 'Paramount+', category: 'TV & film', cycle: 'monthly' },
  { name: 'YouTube TV', category: 'TV & film', cycle: 'monthly' },
  ...
  { name: 'Cell phone', category: 'Phone & internet', cycle: 'monthly' },
  { name: 'Internet', category: 'Phone & internet', cycle: 'monthly' },
  { name: 'Electric', category: 'Bills & utilities', cycle: 'monthly' },
  { name: 'Gas', category: 'Bills & utilities', cycle: 'monthly' },
  { name: 'Water', category: 'Bills & utilities', cycle: 'monthly' },
  { name: 'Car payment', category: 'Bills & utilities', cycle: 'monthly' },
  { name: 'Car insurance', category: 'Bills & utilities', cycle: 'monthly' },
  { name: 'Renters insurance', category: 'Bills & utilities', cycle: 'monthly' },
